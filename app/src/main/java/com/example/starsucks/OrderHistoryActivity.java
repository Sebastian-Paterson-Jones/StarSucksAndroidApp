    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        starSucksRef.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                orderAdapter = new ArrayAdapter<String>(OrderHistoryActivity.this, android.R.layout.simple_list_item_1, orderList);
                lstvOrderHistory.setAdapter(orderAdapter);
            }

            @Override
            public void onCancelled(@NonNull DatabaseError error) {
                Toast.makeText(OrderHistoryActivity.this, "Error reading from database", Toast.LENGTH_SHORT).show();
            }
        });
    }
}